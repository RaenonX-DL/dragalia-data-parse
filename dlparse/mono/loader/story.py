...
from dlparse.mono.asset import ParsedDictIdType, StoryData, StoryNameAsset
...
class StoryLoader:
    ...
    @cache
    def _get_story_data(self, path_in_dir: str, lang: Language, story_id: ParsedDictIdType) -> StoryData:
        return StoryData(
    ...
    def load_unit_story(self, lang: Language, unit_type: UnitType, story_id: ParsedDictIdType) -> StoryData:
