...
class ConditionCategories:
    ...
    target_status_infliction = ConditionCategory[Status](
        {
            ...
            Condition.ON_INFLICTED_ANY: Status.AFFLICTED,
        },
    ...
    self_combo_count = ConditionCategoryTargetNumber(
        {
            ...
            Condition.COMBO_GTE_75: 75,
            Condition.COMBO_GTE_100: 100,
        },
        ConditionMaxCount.SINGLE,
        "Self - combo count",
    ...
    skill_addl_inputs = ConditionCategoryTargetNumber(
        {
            ...
            Condition.ADDL_INPUT_7: 7,
            Condition.ADDL_INPUT_8: 8,
            Condition.ADDL_INPUT_9: 9,
        },
        ConditionMaxCount.SINGLE,
    ...
    trigger = ConditionCategoryGroup(
        hit_by_affliction_correspondence.keys() | {
            ...
            Condition.ON_HP_LT_70,
            Condition.ON_HP_GTE_40,
            Condition.ON_HP_GTE_60,
            Condition.ON_COMBO_RESET,
            Condition.ON_COMBO_GTE_10,
            Condition.ON_COMBO_DIV_BY_1_FS,
            Condition.ON_COMBO_DIV_BY_3_FS,
            Condition.ON_COMBO_DIV_BY_2_HUMAN_S1,
            Condition.ON_COMBO_DIV_BY_3_HUMAN_S1,
            Condition.ON_COMBO_DIV_BY_10_HUMAN_S1,
            Condition.ON_COMBO_DIV_BY_10,
            Condition.ON_COMBO_DIV_BY_15,
            Condition.ON_COMBO_DIV_BY_20,
            Condition.ON_COMBO_DIV_BY_30,
            Condition.ON_COMBO_DIV_BY_35,
            Condition.ON_COMBO_DIV_BY_50,
            Condition.ON_COMBO_DIV_BY_100,
            Condition.ON_HIT,
            Condition.ON_CAUSE_ENEMY_DEF_DOWN,
        },
        ConditionMaxCount.SINGLE,
        "Triggers",
