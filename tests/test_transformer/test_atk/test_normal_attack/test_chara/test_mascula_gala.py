...
def test_s1_normal_attack(transformer_atk: AttackingActionTransformer):
    ...
    combo_1 = data[0]
    assert combo_1.mods == pytest.approx([0.13] * 4 + [0.38])
    assert combo_1.sp_gain == 130
    assert combo_1.utp_gain == 0
    ...
    combo_2 = data[1]
    assert combo_2.mods == pytest.approx([0.19] * 3 + [0.56])
    assert combo_2.sp_gain == 220
    assert combo_2.utp_gain == 0
    ...
    combo_3 = data[2]
    assert combo_3.mods == pytest.approx([0.13] * 7 + [0.37])
    assert combo_3.sp_gain == 360
    assert combo_3.utp_gain == 0
    ...
    combo_4 = data[3]
    assert combo_4.mods == pytest.approx([0.57] * 3 + [1.72])
    assert combo_4.sp_gain == 660
    assert combo_4.utp_gain == 0
...
def test_s2_enhanced_attack_with_s1(transformer_atk: AttackingActionTransformer):
    ...
    combo_1 = data[0]
    assert combo_1.mods == pytest.approx([0.16] + [0.19] * 6 + [0.16] * 3 + [0.45])
    assert combo_1.sp_gain == 130
    assert combo_1.utp_gain == 0
    ...
    combo_2 = data[1]
    assert combo_2.mods == pytest.approx([0.23] + [0.19] * 6 + [0.23] * 2 + [0.67])
    assert combo_2.sp_gain == 220
    assert combo_2.utp_gain == 0
    ...
    combo_3 = data[2]
    assert combo_3.mods == pytest.approx(([0.16] + [0.19] * 3) * 2 + [0.16] * 7 + [0.44])
    assert combo_3.sp_gain == 360
    assert combo_3.utp_gain == 0
    ...
    combo_4 = data[3]
    assert combo_4.mods == pytest.approx([0.68] + ([0.68] + [0.19] * 3) * 2 + [0.68] + [2.03])
    assert combo_4.sp_gain == 660
    assert combo_4.utp_gain == 0
