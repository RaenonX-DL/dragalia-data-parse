...
def test_formal_joachim_s1(transformer_skill: SkillTransformer):
    # Formal Joachim S1
    ...
    expected_addl_at_max = {
        SkillConditionComposite(): 10.12,
        SkillConditionComposite(SkillCondition.CANCELS_FJOACHIM_S2): 20.64,
    }
...
def test_nobunaga_s1(transformer_skill: SkillTransformer):
    # Nobunaga
...
def test_nadine_s1_trendsetting(transformer_skill: SkillTransformer):
