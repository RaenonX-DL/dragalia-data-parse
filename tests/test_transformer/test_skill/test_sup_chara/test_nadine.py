...
def test_sup_s1_trendsetting(transformer_skill: SkillTransformer):
    # Nadine S1 enhanced by S2
    # https://dragalialost.wiki/w/Nadine
    skill_data_base = transformer_skill.transform_supportive(105501023)

    assert skill_data_base.max_level == 3

    expected_buffs = {
        (Condition.COVER_TEAMMATE_0,): {
            BuffEffectInfo(
                "LAN_127_04_2_TENSION_LV03", HitTargetSimple.SELF, BuffParameter.ENERGY_LEVEL, 3, 0, 1
            ),
        },
        ...
        (Condition.COVER_TEAMMATE_2,): {
            BuffEffectInfo(
                "LAN_127_04_3_TENSION_LV03", HitTargetSimple.SELF, BuffParameter.ENERGY_LEVEL, 5, 0, 1
            ),
        },
        (Condition.COVER_TEAMMATE_3,): {
            BuffEffectInfo(
